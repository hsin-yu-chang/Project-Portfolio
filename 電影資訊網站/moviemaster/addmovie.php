    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
      ...
      $movieName="";$directorName = "";  $actorName = "";$showLocationTime = "";  $type = ""; $description = "";
        ...
        if(mysqli_num_rows(mysqli_query($conn,$check))==0){
          $sql="INSERT INTO movie (movieId,movieName,description,type,showLocationTime) 
          VALUES('','".$movieName."','".$description."','".$type."','".$showLocationTime."');";
          $sql.="INSERT INTO actor(actorName,movieId)
          VALUES('".$actorName."',(SELECT movieId FROM movie WHERE movie.movieName='".$movieName."'));";
          $sql.="INSERT INTO director(directorName,movieId)
          VALUES('".$directorName."',(SELECT movieId FROM movie WHERE movie.movieName='".$movieName."'))";
          ...
          $res=$conn->multi_query($sql);
           if($res){
              ...
              echo "新增成功!<br>";
                ...
                //header("refresh:1;url=addmovie.php");
                exit;
            }else{
            ...
            //header("refresh:1;url=addmovie.php",true);
            exit;
        }
    }
  ...
  <main>
    ...
    <div class="row g-5" >
      ...
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">新增電影資訊</h4>
        <form class="needs-validation" action="addmovie.php" method="post">
          ...
          <input type="submit" class="w-100 btn btn-lg btn-primary" value="Add Movie"/>
        </form>
      </div>
    </div>
  </main>
